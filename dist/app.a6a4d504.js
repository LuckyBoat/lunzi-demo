...
exports.default = _default;
        var $a726fe = exports.default || module.exports;
      
      if (typeof $a726fe === 'function') {
        $a726fe = $a726fe.options;
      }
    
        /* template */
        Object.assign($a726fe, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a726fe', $a726fe);
          } else {
            api.reload('$a726fe', $a726fe);
          }
        }
